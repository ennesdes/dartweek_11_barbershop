...
import 'package:project_barbershop_dartweek/src/features/auth/register/barbershop/barbershop_register_vm.dart';
    ...
    ref.listen(barbershopRegisterVmProvider, (_, state) {
      switch (state.status) {
        ...
        case BarbershopRegisterStateStatus.error:
          Messages.showError(
            'Desculpa ocorreu um erro ao registrar barbearia',
            context,
          );
